# Building and Deploying NotificationService.Contracts
...
```bash
git clone https://github.com/openmindednewby/NotificationService.Contracts.git
cd NotificationService.Contracts
```
...
dotnet add package NotificationService.Contracts --version 1.0.2 --source LocalFeed
```
...
<ItemGroup>
  <PackageReference Include="NotificationService.Contracts" Version="1.0.2">
    <Source>C:\path\to\NotificationService.Contracts\artifacts\NotificationService.Contracts.1.0.2.nupkg</Source>
  </PackageReference>
</ItemGroup>
```
...
2. Click **Create**
3. Provide a key name (e.g., "NotificationService.Contracts")
4. Select **Push** scope
5. Select packages or glob pattern (e.g., `NotificationService.Contracts*`)
6. Copy the generated API key

### Step 2: Publish

```bash
dotnet nuget push ./artifacts/NotificationService.Contracts.1.0.2.nupkg \
...
https://www.nuget.org/packages/NotificationService.Contracts
...
unzip NotificationService.Contracts.1.0.2.nupkg -d extracted/
...
```
error: Response status code does not indicate success: 409 (Conflict - The feed already contains 'NotificationService.Contracts' version '1.0.2'.)
```
...
- Issues: [GitHub Issues](https://github.com/openmindednewby/NotificationService.Contracts/issues)
- Discussions: [GitHub Discussions](https://github.com/openmindednewby/NotificationService.Contracts/discussions)
- NuGet: [NuGet Package Page](https://www.nuget.org/packages/NotificationService.Contracts)
